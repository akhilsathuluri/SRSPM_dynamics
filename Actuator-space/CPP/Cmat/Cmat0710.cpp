...
double Cmat0710(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0710 = 0. + 0.20339*ds4*((cp1*cp4*cs4*l1*l4*ss1)/36. + (cs4*l1*l4*sp1*sp4*ss1)/36. - (cs1*l1*l4*ss4)/36.) + 0.20339*dp4*((cp4*l1*l4*sp1*ss1*ss4)/36. - (cp1*l1*l4*sp4*ss1*ss4)/36.) + 0.20339*dl4*((cs1*cs4*l1)/36. + (cp1*cp4*l1*ss1*ss4)/36. + (l1*sp1*sp4*ss1*ss4)/36.);
