...
double Cmat0415(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0415 = 0. + 0.20339*dp3*((cp3*cp4*cs3*cs4*l4)/36. + (cs3*cs4*l4*sp3*sp4)/36.) + 0.20339*ds3*(-(cp4*cs4*l4*sp3*ss3)/36. + (cp3*cs4*l4*sp4*ss3)/36.);
