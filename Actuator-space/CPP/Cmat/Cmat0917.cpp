...
double Cmat0917(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0917 = 0. + 0.20339*dp5*(-(cp5*cs5*l3*sp3*ss3)/36. + (cp3*cs5*l3*sp5*ss3)/36.) + 0.20339*ds5*((cs3*cs5*l3)/36. + (cp3*cp5*l3*ss3*ss5)/36. + (l3*sp3*sp5*ss3*ss5)/36.);
