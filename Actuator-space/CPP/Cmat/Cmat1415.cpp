...
double Cmat1415(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1415 = 0. + 0.20339*dp3*((cp3*cs2*cs3*sp2)/36. - (cp2*cs2*cs3*sp3)/36.) + 0.20339*ds3*((cs3*ss2)/36. - (cp2*cp3*cs2*ss3)/36. - (cs2*sp2*sp3*ss3)/36.);
