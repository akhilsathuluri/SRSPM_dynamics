...
double Cmat0308(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0308 = 0. + 0.20339*ds2*(-(cp3*cs2*cs3*l2*l3*sp2)/36. + (cp2*cs2*cs3*l2*l3*sp3)/36.) + 0.20339*dl2*(-(cp3*cs3*l3*sp2*ss2)/36. + (cp2*cs3*l3*sp3*ss2)/36.) + 0.20339*dp2*(-(cp2*cp3*cs3*l2*l3*ss2)/36. - (cs3*l2*l3*sp2*sp3*ss2)/36.);
