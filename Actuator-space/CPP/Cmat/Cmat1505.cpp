...
double Cmat1505(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1505 = 0. + 0.20339*dl5*((cp5*cs3*cs5*sp3)/36. - (cp3*cs3*cs5*sp5)/36.) + 0.20339*dp5*(-(cp3*cp5*cs3*cs5*l5)/36. - (cs3*cs5*l5*sp3*sp5)/36.) + 0.20339*ds5*(-(cp5*cs3*l5*sp3*ss5)/36. + (cp3*cs3*l5*sp5*ss5)/36.);
