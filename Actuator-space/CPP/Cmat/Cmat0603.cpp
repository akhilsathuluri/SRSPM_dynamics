...
double Cmat0603(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0603 = 0. + 0.20339*dp3*(-(cp6*cs3*cs6*l3*l6*sp3)/36. + (cp3*cs3*cs6*l3*l6*sp6)/36.) + 0.20339*dl3*((cp3*cp6*cs3*cs6*l6)/36. + (cs3*cs6*l6*sp3*sp6)/36.) + 0.20339*ds3*(-(cp3*cp6*cs6*l3*l6*ss3)/36. - (cs6*l3*l6*sp3*sp6*ss3)/36.);
