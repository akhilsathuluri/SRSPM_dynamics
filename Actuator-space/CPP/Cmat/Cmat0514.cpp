...
double Cmat0514(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0514 = 0. + 0.20339*dp2*((cp2*cp5*cs2*cs5*l5)/36. + (cs2*cs5*l5*sp2*sp5)/36.) + 0.20339*ds2*(-(cp5*cs5*l5*sp2*ss2)/36. + (cp2*cs5*l5*sp5*ss2)/36.);
