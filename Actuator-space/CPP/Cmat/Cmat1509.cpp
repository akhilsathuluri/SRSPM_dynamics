...
double Cmat1509(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1509 = 0. + (dl3*(0. + 11.34042298615801*(2*cs3*ss3 - 2*cs3*ss3*pow(cp3,2) - 2*cs3*ss3*pow(sp3,2)) + 0.20339*((cs3*ss3)/18. - (cs3*ss3*pow(cp3,2))/18. - (cs3*ss3*pow(sp3,2))/18.)))/2. + (ds3*(22.68084597231602*((-0.75 + l3)*pow(cs3,2) - (-0.75 + l3)*pow(cp3,2)*pow(cs3,2) - (-0.75 + l3)*pow(cs3,2)*pow(sp3,2) - (-0.75 + l3)*pow(ss3,2) + (-0.75 + l3)*pow(cp3,2)*pow(ss3,2) + (-0.75 + l3)*pow(sp3,2)*pow(ss3,2)) - 11.34042298615801*(2*(-0.75 + l3)*pow(cs3,2) + 2*(-0.75 + l3)*pow(cp3,2)*pow(ss3,2) + 2*(-0.75 + l3)*pow(sp3,2)*pow(ss3,2)) + 0.40678*((l3*pow(cs3,2))/36. - (l3*pow(cp3,2)*pow(cs3,2))/36. - (l3*pow(cs3,2)*pow(sp3,2))/36. - (l3*pow(ss3,2))/36. + (l3*pow(cp3,2)*pow(ss3,2))/36. + (l3*pow(sp3,2)*pow(ss3,2))/36.) - 0.20339*((l3*pow(cs3,2))/18. + (l3*pow(cp3,2)*pow(ss3,2))/18. + (l3*pow(sp3,2)*pow(ss3,2))/18.)))/2.;
