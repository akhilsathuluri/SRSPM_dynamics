...
double Cmat0213(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0213 = 0. + 0.20339*dp1*((cp1*cp2*cs1*cs2*l2)/36. + (cs1*cs2*l2*sp1*sp2)/36.) + 0.20339*ds1*(-(cp2*cs2*l2*sp1*ss1)/36. + (cp1*cs2*l2*sp2*ss1)/36.);
