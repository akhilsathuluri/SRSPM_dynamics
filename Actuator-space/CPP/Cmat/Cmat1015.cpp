...
double Cmat1015(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1015 = 0. + 0.20339*dp3*((cp4*cs3*l4*sp3*ss4)/36. - (cp3*cs3*l4*sp4*ss4)/36.) + 0.20339*ds3*((cs3*cs4*l4)/36. + (cp3*cp4*l4*ss3*ss4)/36. + (l4*sp3*sp4*ss3*ss4)/36.);
