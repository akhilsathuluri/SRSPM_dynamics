...
double Cmat1413(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1413 = 0. + 0.20339*dp1*(-(cp2*cs1*cs2*sp1)/36. + (cp1*cs1*cs2*sp2)/36.) + 0.20339*ds1*(-(cp1*cp2*cs2*ss1)/36. - (cs2*sp1*sp2*ss1)/36. + (cs1*ss2)/36.);
