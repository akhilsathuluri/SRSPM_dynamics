...
double Cmat0215(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0215 = 0. + 0.20339*dp3*((cp2*cp3*cs2*cs3*l2)/36. + (cs2*cs3*l2*sp2*sp3)/36.) + 0.20339*ds3*((cp3*cs2*l2*sp2*ss3)/36. - (cp2*cs2*l2*sp3*ss3)/36.);
