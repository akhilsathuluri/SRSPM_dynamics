...
double Cmat1202(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1202 = 0. + 0.20339*dl2*((cp6*cs2*l6*sp2*ss6)/36. - (cp2*cs2*l6*sp6*ss6)/36.) + 0.20339*dp2*((cp2*cp6*cs2*l2*l6*ss6)/36. + (cs2*l2*l6*sp2*sp6*ss6)/36.) + 0.20339*ds2*(-(cp6*l2*l6*sp2*ss2*ss6)/36. + (cp2*l2*l6*sp6*ss2*ss6)/36.);
