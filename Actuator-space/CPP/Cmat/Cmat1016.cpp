...
double Cmat1016(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1016 = 0. + (dl4*(-11.34042298615801*(2*cs4*ss4 - 2*cs4*ss4*pow(cp4,2) - 2*cs4*ss4*pow(sp4,2)) + 22.68084597231602*(cs4*ss4 - cs4*ss4*pow(cp4,2) - cs4*ss4*pow(sp4,2)) - 0.20339*((cs4*ss4)/18. - (cs4*ss4*pow(cp4,2))/18. - (cs4*ss4*pow(sp4,2))/18.) + 0.40678*((cs4*ss4)/36. - (cs4*ss4*pow(cp4,2))/36. - (cs4*ss4*pow(sp4,2))/36.)))/2. + (ds4*(0. + 11.34042298615801*(2*(-0.75 + l4)*pow(cs4,2) + 2*(-0.75 + l4)*pow(cp4,2)*pow(ss4,2) + 2*(-0.75 + l4)*pow(sp4,2)*pow(ss4,2)) + 0.20339*((l4*pow(cs4,2))/18. + (l4*pow(cp4,2)*pow(ss4,2))/18. + (l4*pow(sp4,2)*pow(ss4,2))/18.)))/2.;
