...
double Cmat0417(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0417 = 0. + 0.20339*dp5*((cp4*cp5*cs4*cs5*l4)/36. + (cs4*cs5*l4*sp4*sp5)/36.) + 0.20339*ds5*((cp5*cs4*l4*sp4*ss5)/36. - (cp4*cs4*l4*sp5*ss5)/36.);
