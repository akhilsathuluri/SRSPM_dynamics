...
double Cmat1405(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1405 = 0. + 0.20339*dl5*((cp5*cs2*cs5*sp2)/36. - (cp2*cs2*cs5*sp5)/36.) + 0.20339*dp5*(-(cp2*cp5*cs2*cs5*l5)/36. - (cs2*cs5*l5*sp2*sp5)/36.) + 0.20339*ds5*(-(cp5*cs2*l5*sp2*ss5)/36. + (cp2*cs2*l5*sp5*ss5)/36.);
