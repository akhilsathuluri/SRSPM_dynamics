...
double Cmat1011(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1011 = 0. + 0.20339*ds5*((cp4*cp5*cs5*l4*l5*ss4)/36. + (cs5*l4*l5*sp4*sp5*ss4)/36. - (cs4*l4*l5*ss5)/36.) + 0.20339*dp5*((cp5*l4*l5*sp4*ss4*ss5)/36. - (cp4*l4*l5*sp5*ss4*ss5)/36.) + 0.20339*dl5*((cs4*cs5*l4)/36. + (cp4*cp5*l4*ss4*ss5)/36. + (l4*sp4*sp5*ss4*ss5)/36.);
