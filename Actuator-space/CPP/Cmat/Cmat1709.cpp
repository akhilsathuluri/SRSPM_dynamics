...
double Cmat1709(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1709 = 0. + 0.20339*dp3*((cp5*cs5*l3*sp3*ss3)/36. - (cp3*cs5*l3*sp5*ss3)/36.) + 0.20339*dl3*(-(cp3*cp5*cs5*ss3)/36. - (cs5*sp3*sp5*ss3)/36. + (cs3*ss5)/36.) + 0.20339*ds3*(-(cp3*cp5*cs3*cs5*l3)/36. - (cs3*cs5*l3*sp3*sp5)/36. - (l3*ss3*ss5)/36.);
