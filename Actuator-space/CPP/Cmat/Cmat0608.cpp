...
double Cmat0608(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0608 = 0. + 0.20339*ds2*(-(cp6*cs2*cs6*l2*l6*sp2)/36. + (cp2*cs2*cs6*l2*l6*sp6)/36.) + 0.20339*dl2*(-(cp6*cs6*l6*sp2*ss2)/36. + (cp2*cs6*l6*sp6*ss2)/36.) + 0.20339*dp2*(-(cp2*cp6*cs6*l2*l6*ss2)/36. - (cs6*l2*l6*sp2*sp6*ss2)/36.);
