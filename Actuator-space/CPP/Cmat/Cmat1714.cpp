...
double Cmat1714(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1714 = 0. + 0.20339*dp2*(-(cp5*cs2*cs5*sp2)/36. + (cp2*cs2*cs5*sp5)/36.) + 0.20339*ds2*(-(cp2*cp5*cs5*ss2)/36. - (cs5*sp2*sp5*ss2)/36. + (cs2*ss5)/36.);
