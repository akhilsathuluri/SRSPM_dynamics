...
double Cmat0401(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0401 = 0. + 0.20339*dp1*(-(cp4*cs1*cs4*l1*l4*sp1)/36. + (cp1*cs1*cs4*l1*l4*sp4)/36.) + 0.20339*dl1*((cp1*cp4*cs1*cs4*l4)/36. + (cs1*cs4*l4*sp1*sp4)/36.) + 0.20339*ds1*(-(cp1*cp4*cs4*l1*l4*ss1)/36. - (cs4*l1*l4*sp1*sp4*ss1)/36.);
