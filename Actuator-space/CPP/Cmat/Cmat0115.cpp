...
double Cmat0115(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0115 = 0. + 0.20339*dp3*((cp1*cp3*cs1*cs3*l1)/36. + (cs1*cs3*l1*sp1*sp3)/36.) + 0.20339*ds3*((cp3*cs1*l1*sp1*ss3)/36. - (cp1*cs1*l1*sp3*ss3)/36.);
