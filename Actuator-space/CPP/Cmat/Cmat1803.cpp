...
double Cmat1803(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1803 = 0. + 0.20339*dl3*(-(cp6*cs3*cs6*sp3)/36. + (cp3*cs3*cs6*sp6)/36.) + 0.20339*dp3*(-(cp3*cp6*cs3*cs6*l3)/36. - (cs3*cs6*l3*sp3*sp6)/36.) + 0.20339*ds3*((cp6*cs6*l3*sp3*ss3)/36. - (cp3*cs6*l3*sp6*ss3)/36.);
