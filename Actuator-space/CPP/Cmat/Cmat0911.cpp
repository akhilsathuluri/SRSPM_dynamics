...
double Cmat0911(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0911 = 0. + 0.20339*ds5*((cp3*cp5*cs5*l3*l5*ss3)/36. + (cs5*l3*l5*sp3*sp5*ss3)/36. - (cs3*l3*l5*ss5)/36.) + 0.20339*dp5*((cp5*l3*l5*sp3*ss3*ss5)/36. - (cp3*l3*l5*sp5*ss3*ss5)/36.) + 0.20339*dl5*((cs3*cs5*l3)/36. + (cp3*cp5*l3*ss3*ss5)/36. + (l3*sp3*sp5*ss3*ss5)/36.);
