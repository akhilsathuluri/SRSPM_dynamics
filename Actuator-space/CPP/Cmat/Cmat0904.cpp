...
double Cmat0904(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0904 = 0. + 0.20339*dl4*(-(cp4*cs4*l3*sp3*ss3)/36. + (cp3*cs4*l3*sp4*ss3)/36.) + 0.20339*dp4*((cp3*cp4*cs4*l3*l4*ss3)/36. + (cs4*l3*l4*sp3*sp4*ss3)/36.) + 0.20339*ds4*((cp4*l3*l4*sp3*ss3*ss4)/36. - (cp3*l3*l4*sp4*ss3*ss4)/36.);
