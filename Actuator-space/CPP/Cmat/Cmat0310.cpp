...
double Cmat0310(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0310 = 0. + 0.20339*ds4*((cp4*cs3*cs4*l3*l4*sp3)/36. - (cp3*cs3*cs4*l3*l4*sp4)/36.) + 0.20339*dl4*((cp4*cs3*l3*sp3*ss4)/36. - (cp3*cs3*l3*sp4*ss4)/36.) + 0.20339*dp4*(-(cp3*cp4*cs3*l3*l4*ss4)/36. - (cs3*l3*l4*sp3*sp4*ss4)/36.);
