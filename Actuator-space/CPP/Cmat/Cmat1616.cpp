...
double Cmat1616(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1616 = 0. + (ds4*(0. + 11.34042298615801*(2*cs4*ss4 - 2*cs4*ss4*pow(cp4,2) - 2*cs4*ss4*pow(sp4,2)) + 0.20339*((cs4*ss4)/18. - (cs4*ss4*pow(cp4,2))/18. - (cs4*ss4*pow(sp4,2))/18.)))/2.;
