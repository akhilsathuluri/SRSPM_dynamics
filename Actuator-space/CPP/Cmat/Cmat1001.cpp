...
double Cmat1001(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1001 = 0. + 0.20339*dl1*((cp4*cs1*l4*sp1*ss4)/36. - (cp1*cs1*l4*sp4*ss4)/36.) + 0.20339*dp1*((cp1*cp4*cs1*l1*l4*ss4)/36. + (cs1*l1*l4*sp1*sp4*ss4)/36.) + 0.20339*ds1*(-(cp4*l1*l4*sp1*ss1*ss4)/36. + (cp1*l1*l4*sp4*ss1*ss4)/36.);
