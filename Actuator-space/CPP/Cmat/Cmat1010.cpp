...
double Cmat1010(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1010 = 0. + (ds4*(1.157186018995715*(-0.125*cs4*ss4 + 0.125*cs4*ss4*pow(cp4,2) + 0.125*cs4*ss4*pow(sp4,2)) + 11.34042298615801*(-2*cs4*ss4*pow(-0.75 + l4,2) + 2*cs4*ss4*pow(cp4,2)*pow(-0.75 + l4,2) + 2*cs4*ss4*pow(-0.75 + l4,2)*pow(sp4,2)) + 0.20339*(-(cs4*ss4*pow(l4,2))/18. + (cs4*ss4*pow(cp4,2)*pow(l4,2))/18. + (cs4*ss4*pow(l4,2)*pow(sp4,2))/18.)))/2. + (dl4*(0. + 11.34042298615801*(2*(-0.75 + l4)*pow(cs4,2) + 2*(-0.75 + l4)*pow(cp4,2)*pow(ss4,2) + 2*(-0.75 + l4)*pow(sp4,2)*pow(ss4,2)) + 0.20339*((l4*pow(cs4,2))/18. + (l4*pow(cp4,2)*pow(ss4,2))/18. + (l4*pow(sp4,2)*pow(ss4,2))/18.)))/2.;
