...
double Cmat0803(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0803 = 0. + 0.20339*dl3*(-(cp3*cs3*l2*sp2*ss2)/36. + (cp2*cs3*l2*sp3*ss2)/36.) + 0.20339*dp3*((cp2*cp3*cs3*l2*l3*ss2)/36. + (cs3*l2*l3*sp2*sp3*ss2)/36.) + 0.20339*ds3*((cp3*l2*l3*sp2*ss2*ss3)/36. - (cp2*l2*l3*sp3*ss2*ss3)/36.);
