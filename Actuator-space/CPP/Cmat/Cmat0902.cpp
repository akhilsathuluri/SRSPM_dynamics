...
double Cmat0902(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0902 = 0. + 0.20339*dl2*((cp3*cs2*l3*sp2*ss3)/36. - (cp2*cs2*l3*sp3*ss3)/36.) + 0.20339*dp2*((cp2*cp3*cs2*l2*l3*ss3)/36. + (cs2*l2*l3*sp2*sp3*ss3)/36.) + 0.20339*ds2*(-(cp3*l2*l3*sp2*ss2*ss3)/36. + (cp2*l2*l3*sp3*ss2*ss3)/36.);
