...
double Cmat0307(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0307 = 0. + 0.20339*ds1*(-(cp3*cs1*cs3*l1*l3*sp1)/36. + (cp1*cs1*cs3*l1*l3*sp3)/36.) + 0.20339*dl1*(-(cp3*cs3*l3*sp1*ss1)/36. + (cp1*cs3*l3*sp3*ss1)/36.) + 0.20339*dp1*(-(cp1*cp3*cs3*l1*l3*ss1)/36. - (cs3*l1*l3*sp1*sp3*ss1)/36.);
