...
double Cmat0715(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0715 = 0. + 0.20339*dp3*(-(cp3*cs3*l1*sp1*ss1)/36. + (cp1*cs3*l1*sp3*ss1)/36.) + 0.20339*ds3*((cs1*cs3*l1)/36. + (cp1*cp3*l1*ss1*ss3)/36. + (l1*sp1*sp3*ss1*ss3)/36.);
