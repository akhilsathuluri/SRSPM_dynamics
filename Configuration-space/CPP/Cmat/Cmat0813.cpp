...
double Cmat0813(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0813 = 0. + 0.20339*dp1*((cp2*cs1*l2*sp1*ss2)/36. - (cp1*cs1*l2*sp2*ss2)/36.) + 0.20339*ds1*((cs1*cs2*l2)/36. + (cp1*cp2*l2*ss1*ss2)/36. + (l2*sp1*sp2*ss1*ss2)/36.);
