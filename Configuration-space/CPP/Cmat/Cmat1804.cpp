...
double Cmat1804(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1804 = 0. + 0.20339*dl4*(-(cp6*cs4*cs6*sp4)/36. + (cp4*cs4*cs6*sp6)/36.) + 0.20339*dp4*(-(cp4*cp6*cs4*cs6*l4)/36. - (cs4*cs6*l4*sp4*sp6)/36.) + 0.20339*ds4*((cp6*cs6*l4*sp4*ss4)/36. - (cp4*cs6*l4*sp6*ss4)/36.);
