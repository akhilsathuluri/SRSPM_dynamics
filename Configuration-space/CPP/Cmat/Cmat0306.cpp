...
double Cmat0306(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0306 = 0. + 0.20339*dp6*((cp6*cs3*cs6*l3*l6*sp3)/36. - (cp3*cs3*cs6*l3*l6*sp6)/36.) + 0.20339*dl6*((cp3*cp6*cs3*cs6*l3)/36. + (cs3*cs6*l3*sp3*sp6)/36.) + 0.20339*ds6*(-(cp3*cp6*cs3*l3*l6*ss6)/36. - (cs3*l3*l6*sp3*sp6*ss6)/36.);
