...
double Cmat0114(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0114 = 0. + 0.20339*dp2*((cp1*cp2*cs1*cs2*l1)/36. + (cs1*cs2*l1*sp1*sp2)/36.) + 0.20339*ds2*((cp2*cs1*l1*sp1*ss2)/36. - (cp1*cs1*l1*sp2*ss2)/36.);
