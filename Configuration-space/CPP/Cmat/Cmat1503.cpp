...
double Cmat1503(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1503 = 0. + (dp3*(-11.34042298615801*(2*(-0.75 + l3)*pow(cp3,2)*pow(cs3,2) + 2*(-0.75 + l3)*pow(cs3,2)*pow(sp3,2)) - 0.20339*((l3*pow(cp3,2)*pow(cs3,2))/18. + (l3*pow(cs3,2)*pow(sp3,2))/18.)))/2.;
