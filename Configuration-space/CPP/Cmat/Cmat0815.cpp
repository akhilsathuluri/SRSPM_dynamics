...
double Cmat0815(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0815 = 0. + 0.20339*dp3*(-(cp3*cs3*l2*sp2*ss2)/36. + (cp2*cs3*l2*sp3*ss2)/36.) + 0.20339*ds3*((cs2*cs3*l2)/36. + (cp2*cp3*l2*ss2*ss3)/36. + (l2*sp2*sp3*ss2*ss3)/36.);
