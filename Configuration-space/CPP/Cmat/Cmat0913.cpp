...
double Cmat0913(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0913 = 0. + 0.20339*dp1*((cp3*cs1*l3*sp1*ss3)/36. - (cp1*cs1*l3*sp3*ss3)/36.) + 0.20339*ds1*((cs1*cs3*l3)/36. + (cp1*cp3*l3*ss1*ss3)/36. + (l3*sp1*sp3*ss1*ss3)/36.);
