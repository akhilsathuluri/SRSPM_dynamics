...
double Cmat0914(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0914 = 0. + 0.20339*dp2*((cp3*cs2*l3*sp2*ss3)/36. - (cp2*cs2*l3*sp3*ss3)/36.) + 0.20339*ds2*((cs2*cs3*l3)/36. + (cp2*cp3*l3*ss2*ss3)/36. + (l3*sp2*sp3*ss2*ss3)/36.);
