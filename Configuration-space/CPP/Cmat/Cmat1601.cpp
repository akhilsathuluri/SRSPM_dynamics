...
double Cmat1601(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1601 = 0. + 0.20339*dl1*(-(cp4*cs1*cs4*sp1)/36. + (cp1*cs1*cs4*sp4)/36.) + 0.20339*dp1*(-(cp1*cp4*cs1*cs4*l1)/36. - (cs1*cs4*l1*sp1*sp4)/36.) + 0.20339*ds1*((cp4*cs4*l1*sp1*ss1)/36. - (cp1*cs4*l1*sp4*ss1)/36.);
