...
double Cmat0805(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0805 = 0. + 0.20339*dl5*(-(cp5*cs5*l2*sp2*ss2)/36. + (cp2*cs5*l2*sp5*ss2)/36.) + 0.20339*dp5*((cp2*cp5*cs5*l2*l5*ss2)/36. + (cs5*l2*l5*sp2*sp5*ss2)/36.) + 0.20339*ds5*((cp5*l2*l5*sp2*ss2*ss5)/36. - (cp2*l2*l5*sp5*ss2*ss5)/36.);
