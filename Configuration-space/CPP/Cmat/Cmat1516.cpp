...
double Cmat1516(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1516 = 0. + 0.20339*dp4*((cp4*cs3*cs4*sp3)/36. - (cp3*cs3*cs4*sp4)/36.) + 0.20339*ds4*((cs4*ss3)/36. - (cp3*cp4*cs3*ss4)/36. - (cs3*sp3*sp4*ss4)/36.);
