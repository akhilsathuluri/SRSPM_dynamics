...
double Cmat1814(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1814 = 0. + 0.20339*dp2*(-(cp6*cs2*cs6*sp2)/36. + (cp2*cs2*cs6*sp6)/36.) + 0.20339*ds2*(-(cp2*cp6*cs6*ss2)/36. - (cs6*sp2*sp6*ss2)/36. + (cs2*ss6)/36.);
