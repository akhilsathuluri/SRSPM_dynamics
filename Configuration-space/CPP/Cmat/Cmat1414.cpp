...
double Cmat1414(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1414 = 0. + (ds2*(0. + 11.34042298615801*(2*cs2*ss2 - 2*cs2*ss2*pow(cp2,2) - 2*cs2*ss2*pow(sp2,2)) + 0.20339*((cs2*ss2)/18. - (cs2*ss2*pow(cp2,2))/18. - (cs2*ss2*pow(sp2,2))/18.)))/2.;
