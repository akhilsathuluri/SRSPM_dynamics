...
double Cmat0818(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0818 = 0. + 0.20339*dp6*(-(cp6*cs6*l2*sp2*ss2)/36. + (cp2*cs6*l2*sp6*ss2)/36.) + 0.20339*ds6*((cs2*cs6*l2)/36. + (cp2*cp6*l2*ss2*ss6)/36. + (l2*sp2*sp6*ss2*ss6)/36.);
