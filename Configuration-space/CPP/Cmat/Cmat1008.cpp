...
double Cmat1008(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1008 = 0. + 0.20339*ds2*(-(cs4*l2*l4*ss2)/36. + (cp2*cp4*cs2*l2*l4*ss4)/36. + (cs2*l2*l4*sp2*sp4*ss4)/36.) + 0.20339*dp2*(-(cp4*l2*l4*sp2*ss2*ss4)/36. + (cp2*l2*l4*sp4*ss2*ss4)/36.) + 0.20339*dl2*((cs2*cs4*l4)/36. + (cp2*cp4*l4*ss2*ss4)/36. + (l4*sp2*sp4*ss2*ss4)/36.);
