...
double Cmat0416(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0416 = 0. + (dp4*(11.34042298615801*(2*(-0.75 + l4)*pow(cp4,2)*pow(cs4,2) + 2*(-0.75 + l4)*pow(cs4,2)*pow(sp4,2)) + 0.20339*((l4*pow(cp4,2)*pow(cs4,2))/18. + (l4*pow(cs4,2)*pow(sp4,2))/18.)))/2.;
