...
double Cmat0916(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0916 = 0. + 0.20339*dp4*(-(cp4*cs4*l3*sp3*ss3)/36. + (cp3*cs4*l3*sp4*ss3)/36.) + 0.20339*ds4*((cs3*cs4*l3)/36. + (cp3*cp4*l3*ss3*ss4)/36. + (l3*sp3*sp4*ss3*ss4)/36.);
