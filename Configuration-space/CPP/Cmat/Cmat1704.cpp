...
double Cmat1704(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1704 = 0. + 0.20339*dl4*(-(cp5*cs4*cs5*sp4)/36. + (cp4*cs4*cs5*sp5)/36.) + 0.20339*dp4*(-(cp4*cp5*cs4*cs5*l4)/36. - (cs4*cs5*l4*sp4*sp5)/36.) + 0.20339*ds4*((cp5*cs5*l4*sp4*ss4)/36. - (cp4*cs5*l4*sp5*ss4)/36.);
