...
double Cmat1006(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1006 = 0. + 0.20339*dl6*(-(cp6*cs6*l4*sp4*ss4)/36. + (cp4*cs6*l4*sp6*ss4)/36.) + 0.20339*dp6*((cp4*cp6*cs6*l4*l6*ss4)/36. + (cs6*l4*l6*sp4*sp6*ss4)/36.) + 0.20339*ds6*((cp6*l4*l6*sp4*ss4*ss6)/36. - (cp4*l4*l6*sp6*ss4*ss6)/36.);
