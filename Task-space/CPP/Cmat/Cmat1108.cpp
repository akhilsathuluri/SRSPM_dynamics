...
double Cmat1108(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1108 = 0. + 0.20339*ds2*(-(cs5*l2*l5*ss2)/36. + (cp2*cp5*cs2*l2*l5*ss5)/36. + (cs2*l2*l5*sp2*sp5*ss5)/36.) + 0.20339*dp2*(-(cp5*l2*l5*sp2*ss2*ss5)/36. + (cp2*l2*l5*sp5*ss2*ss5)/36.) + 0.20339*dl2*((cs2*cs5*l5)/36. + (cp2*cp5*l5*ss2*ss5)/36. + (l5*sp2*sp5*ss2*ss5)/36.);
