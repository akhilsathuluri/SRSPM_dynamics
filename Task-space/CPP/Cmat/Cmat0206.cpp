...
double Cmat0206(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0206 = 0. + 0.20339*dp6*((cp6*cs2*cs6*l2*l6*sp2)/36. - (cp2*cs2*cs6*l2*l6*sp6)/36.) + 0.20339*dl6*((cp2*cp6*cs2*cs6*l2)/36. + (cs2*cs6*l2*sp2*sp6)/36.) + 0.20339*ds6*(-(cp2*cp6*cs2*l2*l6*ss6)/36. - (cs2*l2*l6*sp2*sp6*ss6)/36.);
