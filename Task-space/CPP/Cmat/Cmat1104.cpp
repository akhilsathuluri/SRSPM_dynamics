...
double Cmat1104(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1104 = 0. + 0.20339*dl4*((cp5*cs4*l5*sp4*ss5)/36. - (cp4*cs4*l5*sp5*ss5)/36.) + 0.20339*dp4*((cp4*cp5*cs4*l4*l5*ss5)/36. + (cs4*l4*l5*sp4*sp5*ss5)/36.) + 0.20339*ds4*(-(cp5*l4*l5*sp4*ss4*ss5)/36. + (cp4*l4*l5*sp5*ss4*ss5)/36.);
