...
double Cmat1018(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1018 = 0. + 0.20339*dp6*(-(cp6*cs6*l4*sp4*ss4)/36. + (cp4*cs6*l4*sp6*ss4)/36.) + 0.20339*ds6*((cs4*cs6*l4)/36. + (cp4*cp6*l4*ss4*ss6)/36. + (l4*sp4*sp6*ss4*ss6)/36.);
