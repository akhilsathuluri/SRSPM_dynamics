...
double Cmat0216(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0216 = 0. + 0.20339*dp4*((cp2*cp4*cs2*cs4*l2)/36. + (cs2*cs4*l2*sp2*sp4)/36.) + 0.20339*ds4*((cp4*cs2*l2*sp2*ss4)/36. - (cp2*cs2*l2*sp4*ss4)/36.);
