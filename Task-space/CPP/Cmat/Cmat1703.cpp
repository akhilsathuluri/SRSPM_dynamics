...
double Cmat1703(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1703 = 0. + 0.20339*dl3*(-(cp5*cs3*cs5*sp3)/36. + (cp3*cs3*cs5*sp5)/36.) + 0.20339*dp3*(-(cp3*cp5*cs3*cs5*l3)/36. - (cs3*cs5*l3*sp3*sp5)/36.) + 0.20339*ds3*((cp5*cs5*l3*sp3*ss3)/36. - (cp3*cs5*l3*sp5*ss3)/36.);
