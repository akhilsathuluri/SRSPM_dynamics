...
double Cmat1515(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1515 = 0. + (ds3*(0. + 11.34042298615801*(2*cs3*ss3 - 2*cs3*ss3*pow(cp3,2) - 2*cs3*ss3*pow(sp3,2)) + 0.20339*((cs3*ss3)/18. - (cs3*ss3*pow(cp3,2))/18. - (cs3*ss3*pow(sp3,2))/18.)))/2.;
