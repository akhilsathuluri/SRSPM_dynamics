...
double Cmat1109(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1109 = 0. + 0.20339*ds3*(-(cs5*l3*l5*ss3)/36. + (cp3*cp5*cs3*l3*l5*ss5)/36. + (cs3*l3*l5*sp3*sp5*ss5)/36.) + 0.20339*dp3*(-(cp5*l3*l5*sp3*ss3*ss5)/36. + (cp3*l3*l5*sp5*ss3*ss5)/36.) + 0.20339*dl3*((cs3*cs5*l5)/36. + (cp3*cp5*l5*ss3*ss5)/36. + (l5*sp3*sp5*ss3*ss5)/36.);
