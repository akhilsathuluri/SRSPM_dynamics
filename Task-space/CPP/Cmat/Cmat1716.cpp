...
double Cmat1716(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1716 = 0. + 0.20339*dp4*(-(cp5*cs4*cs5*sp4)/36. + (cp4*cs4*cs5*sp5)/36.) + 0.20339*ds4*(-(cp4*cp5*cs5*ss4)/36. - (cs5*sp4*sp5*ss4)/36. + (cs4*ss5)/36.);
