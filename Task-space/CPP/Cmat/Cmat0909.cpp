...
double Cmat0909(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0909 = 0. + (ds3*(1.157186018995715*(-0.125*cs3*ss3 + 0.125*cs3*ss3*pow(cp3,2) + 0.125*cs3*ss3*pow(sp3,2)) + 11.34042298615801*(-2*cs3*ss3*pow(-0.75 + l3,2) + 2*cs3*ss3*pow(cp3,2)*pow(-0.75 + l3,2) + 2*cs3*ss3*pow(-0.75 + l3,2)*pow(sp3,2)) + 0.20339*(-(cs3*ss3*pow(l3,2))/18. + (cs3*ss3*pow(cp3,2)*pow(l3,2))/18. + (cs3*ss3*pow(l3,2)*pow(sp3,2))/18.)))/2. + (dl3*(0. + 11.34042298615801*(2*(-0.75 + l3)*pow(cs3,2) + 2*(-0.75 + l3)*pow(cp3,2)*pow(ss3,2) + 2*(-0.75 + l3)*pow(sp3,2)*pow(ss3,2)) + 0.20339*((l3*pow(cs3,2))/18. + (l3*pow(cp3,2)*pow(ss3,2))/18. + (l3*pow(sp3,2)*pow(ss3,2))/18.)))/2.;
