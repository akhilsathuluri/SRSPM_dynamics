...
double Cmat0903(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0903 = 0. + (dp3*(4.2987295703513615*cs3*ss3 - 1.157186018995715*(-0.125*cs3*ss3*pow(cp3,2) - 0.125*cs3*ss3*pow(sp3,2)) - 11.34042298615801*(-2*cs3*ss3*pow(cp3,2)*pow(-0.75 + l3,2) - 2*cs3*ss3*pow(-0.75 + l3,2)*pow(sp3,2)) - 0.20339*(-(cs3*ss3*pow(cp3,2)*pow(l3,2))/18. - (cs3*ss3*pow(l3,2)*pow(sp3,2))/18.)))/2.;
