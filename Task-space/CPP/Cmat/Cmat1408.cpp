...
double Cmat1408(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1408 = 0. + (dl2*(0. + 11.34042298615801*(2*cs2*ss2 - 2*cs2*ss2*pow(cp2,2) - 2*cs2*ss2*pow(sp2,2)) + 0.20339*((cs2*ss2)/18. - (cs2*ss2*pow(cp2,2))/18. - (cs2*ss2*pow(sp2,2))/18.)))/2. + (ds2*(22.68084597231602*((-0.75 + l2)*pow(cs2,2) - (-0.75 + l2)*pow(cp2,2)*pow(cs2,2) - (-0.75 + l2)*pow(cs2,2)*pow(sp2,2) - (-0.75 + l2)*pow(ss2,2) + (-0.75 + l2)*pow(cp2,2)*pow(ss2,2) + (-0.75 + l2)*pow(sp2,2)*pow(ss2,2)) - 11.34042298615801*(2*(-0.75 + l2)*pow(cs2,2) + 2*(-0.75 + l2)*pow(cp2,2)*pow(ss2,2) + 2*(-0.75 + l2)*pow(sp2,2)*pow(ss2,2)) + 0.40678*((l2*pow(cs2,2))/36. - (l2*pow(cp2,2)*pow(cs2,2))/36. - (l2*pow(cs2,2)*pow(sp2,2))/36. - (l2*pow(ss2,2))/36. + (l2*pow(cp2,2)*pow(ss2,2))/36. + (l2*pow(sp2,2)*pow(ss2,2))/36.) - 0.20339*((l2*pow(cs2,2))/18. + (l2*pow(cp2,2)*pow(ss2,2))/18. + (l2*pow(sp2,2)*pow(ss2,2))/18.)))/2.;
