...
double Cmat0806(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0806 = 0. + 0.20339*dl6*(-(cp6*cs6*l2*sp2*ss2)/36. + (cp2*cs6*l2*sp6*ss2)/36.) + 0.20339*dp6*((cp2*cp6*cs6*l2*l6*ss2)/36. + (cs6*l2*l6*sp2*sp6*ss2)/36.) + 0.20339*ds6*((cp6*l2*l6*sp2*ss2*ss6)/36. - (cp2*l2*l6*sp6*ss2*ss6)/36.);
