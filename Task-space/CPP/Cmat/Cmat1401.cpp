...
double Cmat1401(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1401 = 0. + 0.20339*dl1*(-(cp2*cs1*cs2*sp1)/36. + (cp1*cs1*cs2*sp2)/36.) + 0.20339*dp1*(-(cp1*cp2*cs1*cs2*l1)/36. - (cs1*cs2*l1*sp1*sp2)/36.) + 0.20339*ds1*((cp2*cs2*l1*sp1*ss1)/36. - (cp1*cs2*l1*sp2*ss1)/36.);
