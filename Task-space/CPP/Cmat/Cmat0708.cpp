...
double Cmat0708(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0708 = 0. + 0.20339*ds2*((cp1*cp2*cs2*l1*l2*ss1)/36. + (cs2*l1*l2*sp1*sp2*ss1)/36. - (cs1*l1*l2*ss2)/36.) + 0.20339*dp2*((cp2*l1*l2*sp1*ss1*ss2)/36. - (cp1*l1*l2*sp2*ss1*ss2)/36.) + 0.20339*dl2*((cs1*cs2*l1)/36. + (cp1*cp2*l1*ss1*ss2)/36. + (l1*sp1*sp2*ss1*ss2)/36.);
