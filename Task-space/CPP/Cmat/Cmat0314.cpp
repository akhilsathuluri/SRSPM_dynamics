...
double Cmat0314(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat0314 = 0. + 0.20339*dp2*((cp2*cp3*cs2*cs3*l3)/36. + (cs2*cs3*l3*sp2*sp3)/36.) + 0.20339*ds2*(-(cp3*cs3*l3*sp2*ss2)/36. + (cp2*cs3*l3*sp3*ss2)/36.);
