...
double Cmat1210(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1210 = 0. + 0.20339*ds4*(-(cs6*l4*l6*ss4)/36. + (cp4*cp6*cs4*l4*l6*ss6)/36. + (cs4*l4*l6*sp4*sp6*ss6)/36.) + 0.20339*dp4*(-(cp6*l4*l6*sp4*ss4*ss6)/36. + (cp4*l4*l6*sp6*ss4*ss6)/36.) + 0.20339*dl4*((cs4*cs6*l6)/36. + (cp4*cp6*l6*ss4*ss6)/36. + (l6*sp4*sp6*ss4*ss6)/36.);
