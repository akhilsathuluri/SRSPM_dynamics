...
double Cmat1708(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1708 = 0. + 0.20339*dp2*((cp5*cs5*l2*sp2*ss2)/36. - (cp2*cs5*l2*sp5*ss2)/36.) + 0.20339*dl2*(-(cp2*cp5*cs5*ss2)/36. - (cs5*sp2*sp5*ss2)/36. + (cs2*ss5)/36.) + 0.20339*ds2*(-(cp2*cp5*cs2*cs5*l2)/36. - (cs2*cs5*l2*sp2*sp5)/36. - (l2*ss2*ss5)/36.);
