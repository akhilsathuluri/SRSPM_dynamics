...
double Cmat1116(double* gen_coords, double* dgen_coords)
{
	//Variables
...
cp6=cos(p6);
	...
	double Cmat1116 = 0. + 0.20339*dp4*((cp5*cs4*l5*sp4*ss5)/36. - (cp4*cs4*l5*sp5*ss5)/36.) + 0.20339*ds4*((cs4*cs5*l5)/36. + (cp4*cp5*l5*ss4*ss5)/36. + (l5*sp4*sp5*ss4*ss5)/36.);
